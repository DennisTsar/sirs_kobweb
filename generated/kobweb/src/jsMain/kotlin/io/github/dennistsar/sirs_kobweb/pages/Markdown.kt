...
fun MarkdownPage() {
    CompositionLocalProvider(LocalMarkdownContext provides MarkdownContext("Markdown.md", mapOf("root" to listOf(".components.layouts.PageLayout(\"MARKDOWN\")")))) {
        io.github.dennistsar.sirs_kobweb.components.layouts.PageLayout("MARKDOWN") {
            ...
            org.jetbrains.compose.web.dom.P {
                ...
                com.varabyte.kobweb.silk.components.navigation.Link("https://compose-web.ui.pages.jetbrains.team/", "Compose for Web")
